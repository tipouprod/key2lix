...
If you did not create an account, you can safely ignore this email.`;
  ...
  if (_emailJsServiceId && _emailJsTemplateId && _emailJsPublicKey && _emailJsPrivateKey) {
    var verificationBody = (t.body || '').replace(/\n/g, '<br>');
    if (verificationBody) verificationBody = wrapEmailWithLogo(verificationBody);
...
If you did not request this, you can ignore this email; your account is secure and your password will not be changed.`;
  ...
  if (_emailJsServiceId && _emailJsTemplateId && _emailJsPublicKey && _emailJsPrivateKey) {
    var resetBody = (t.body || '').replace(/\n/g, '<br>');
    if (resetBody) resetBody = wrapEmailWithLogo(resetBody);
    return sendViaEmailJs({ to_email: to, subject: t.subject, body_html: resetBody, reset_link: resetLink });
  }
