...
/** بناء HTML احترافي لرسالة التحقق (رمز التأكيد). */
function buildVerificationEmailHtml(codeStr) {
  var code = String(codeStr || '').trim();
  return '<div style="font-family:\'Segoe UI\',Tahoma,Geneva,Verdana,sans-serif;color:#1e293b;font-size:15px;line-height:1.65;direction:rtl;text-align:right;">' +
    '<p style="margin:0 0 20px;font-size:18px;font-weight:600;color:#0f172a;">مرحباً،</p>' +
    '<p style="margin:0 0 24px;color:#475569;">شكراً لتسجيلك في Key2lix. لتفعيل حسابك، استخدم رمز التأكيد التالي:</p>' +
    '<table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 0 24px;"><tr><td style="background:linear-gradient(135deg,#f1f5f9 0%,#e2e8f0 100%);border:1px solid #cbd5e1;border-radius:12px;padding:20px 28px;text-align:center;">' +
    '<p style="margin:0 0 6px;font-size:11px;color:#64748b;text-transform:uppercase;letter-spacing:0.08em;">رمز التأكيد</p>' +
    '<p style="margin:0;font-size:28px;font-weight:700;letter-spacing:8px;color:#0f172a;font-family:\'Consolas\',\'Monaco\',monospace;">' + code + '</p>' +
    '</td></tr></table>' +
    '<ul style="margin:0 0 24px;padding:0 0 0 20px;color:#475569;font-size:14px;">' +
    '<li style="margin:0 0 6px;">الرمز صالح لمدة 15 دقيقة.</li>' +
    '<li style="margin:0;">أدخل الرمز في صفحة «حسابي» في الموقع.</li></ul>' +
    '<p style="margin:0 0 28px;font-size:13px;color:#94a3b8;">إذا لم تقم بالتسجيل، يمكنك تجاهل هذا البريد.</p>' +
    '<div style="border-top:1px solid #e2e8f0;padding-top:20px;margin-top:20px;direction:ltr;text-align:left;">' +
    '<p style="margin:0 0 12px;font-size:14px;color:#64748b;">Hello,</p>' +
    '<p style="margin:0 0 16px;color:#475569;">Thank you for signing up with Key2lix. Use this code to verify your email:</p>' +
    '<p style="margin:0 0 12px;font-size:22px;font-weight:700;letter-spacing:4px;color:#0f172a;font-family:\'Consolas\',monospace;">' + code + '</p>' +
    '<p style="margin:0;font-size:13px;color:#94a3b8;">Valid for 15 minutes. Enter it in the "My account" section. If you didn\'t sign up, ignore this email.</p></div></div>';
}
...
/** بناء HTML احترافي لرسالة إعادة تعيين كلمة المرور. */
function buildPasswordResetEmailHtml(link) {
  var url = String(link || '').trim();
  return '<div style="font-family:\'Segoe UI\',Tahoma,Geneva,Verdana,sans-serif;color:#1e293b;font-size:15px;line-height:1.65;direction:rtl;text-align:right;">' +
    '<p style="margin:0 0 20px;font-size:18px;font-weight:600;color:#0f172a;">مرحباً،</p>' +
    '<p style="margin:0 0 24px;color:#475569;">تلقينا طلباً لإعادة تعيين كلمة المرور لحسابك على Key2lix.</p>' +
    '<p style="margin:0 0 12px;color:#475569;">لتعيين كلمة مرور جديدة، اضغط على الرابط التالي (صالح لمدة ساعة):</p>' +
    '<table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 0 24px;"><tr><td style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:10px;padding:16px 20px;text-align:center;">' +
    '<a href="' + url + '" style="color:#2563eb;font-weight:600;text-decoration:none;word-break:break-all;">' + url + '</a>' +
    '</td></tr></table>' +
    '<p style="margin:0 0 28px;font-size:13px;color:#94a3b8;">إذا لم تطلب إعادة التعيين، تجاهل هذا البريد؛ حسابك آمن.</p>' +
    '<div style="border-top:1px solid #e2e8f0;padding-top:20px;margin-top:20px;direction:ltr;text-align:left;">' +
    '<p style="margin:0 0 12px;font-size:14px;color:#64748b;">Hello,</p>' +
    '<p style="margin:0 0 16px;color:#475569;">We received a password reset request. Open the link below to set a new password (valid 1 hour):</p>' +
    '<p style="margin:0;"><a href="' + url + '" style="color:#2563eb;font-weight:600;text-decoration:none;word-break:break-all;">' + url + '</a></p>' +
    '<p style="margin:12px 0 0;font-size:13px;color:#94a3b8;">If you didn\'t request this, ignore this email.</p></div></div>';
}
