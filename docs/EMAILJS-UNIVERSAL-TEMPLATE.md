...
| `body_html` | **محتوى الرسالة كاملًا (HTML)** — استخدمه لعرض كل الرسائل |
...
- **المحتوى (Content / Body):** اعرض `body_html` كـ **HTML خام**:
  - في EmailJS عادة يُكتب: `{{{body_html}}}` (ثلاثة أقواس لعدم تهريب HTML)
  - أو إذا كان المحرر يدعم "raw HTML" فاستخدم الحقل المناسب لـ `body_html`
