...
3. يمكنك تحميل أي نسخة سابقة من القائمة (رابط تحميل بجانب كل نسخة)، أو **استعادة** قاعدة البيانات من نسخة: اضغط زر **«استعادة»** بجانب النسخة المطلوبة ثم أكّد — ستُستبدل القاعدة الحالية بالنسخة المُختارة ويُعاد تحميلها فوراً.
