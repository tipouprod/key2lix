...
| `SESSION_SECRET` | سر الجلسات (أكثر من 32 حرفاً) | سلسلة عشوائية طويلة |
| `BASE_URL` | رابط الموقع بعد النشر | `https://your-app.up.railway.app` |

الباقي اختياري حسب إعداداتك (البريد، الدفع، إلخ). يمكنك نسخ ما تحتاجه من `.env` المحلي (بدون كلمات السر الحساسة إن أردت).
